    ...
    <React.Fragment>
      ...
      <Navbar.Collapse id="sidemenu">
        <Nav className="col-md-12 d-block bg-light sidebar pt-1">
          ...
          <Nav.Item>
            <Nav.Link as={Link} to="/apps/app" eventKey="app">Apps</Nav.Link>
          </Nav.Item>
          <hr/>
          <Nav.Item>
            <Nav.Link as={Link} to="/apps/versions">Versions</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link as={Link} to="/apps/domain">Domain</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link as={Link} to="/apps/instances" eventKey="instances">Instances</Nav.Link>
          </Nav.Item>
          <Nav.Item>
